...
function load_details(my_api_key,title){
  $.ajax({
    type: 'GET',
    url:'https://api.themoviedb.org/3/search/movie?api_key=5492165c61b1a21c06eb3a3b578a6339&query='+title,
...
function get_movie_details(movie_id,my_api_key,arr,movie_title) {
  $.ajax({
    type:'GET',
    url:'https://api.themoviedb.org/3/movie/'+movie_id+'?api_key=5492165c61b1a21c06eb3a3b578a6339',
...
function get_individual_cast(movie_cast,my_api_key) {
    ...
    for(var cast_id in movie_cast.cast_ids){
      $.ajax({
        type:'GET',
        url:'https://api.themoviedb.org/3/person/'+movie_cast.cast_ids[cast_id]+'?api_key=5492165c61b1a21c06eb3a3b578a6339',
        async:false,
...
function get_movie_cast(movie_id,my_api_key){
    ...
    $.ajax({
      type:'GET',
      url:"https://api.themoviedb.org/3/movie/"+movie_id+"/credits?api_key=5492165c61b1a21c06eb3a3b578a6339",
      async:false,
...
function get_movie_posters(arr,my_api_key){
  ...
  for(var m in arr) {
    $.ajax({
      type:'GET',
      url:'https://api.themoviedb.org/3/search/movie?api_key=5492165c61b1a21c06eb3a3b578a6339&query='+arr[m],
      async: false,
